...
/*package*/ class MySpecialEntityDefinition_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public MySpecialEntityDefinition_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      editorCell.value.setCellId("DiagramNode_agar6s_a");
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_agar6s_a0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new membersListHandler_agar6s_a0a(myNode, getEditorContext());
  ...
  private static class membersListHandler_agar6s_a0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public membersListHandler_agar6s_a0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(membersListHandler_agar6s_a0a.this.getNode(), LINKS.members$sAD8));
      try {
  ...
  private EditorCell createCompartment_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("Compartment_agar6s_b0a");
    return editorCell;
  }
