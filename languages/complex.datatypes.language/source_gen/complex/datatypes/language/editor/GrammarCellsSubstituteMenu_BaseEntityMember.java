...
public class GrammarCellsSubstituteMenu_BaseEntityMember extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BaseEntityMember() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cddj79_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BaseEntityMember", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cddj79_a extends GrammarCellsSubstituteMenuPart {
    @Override
