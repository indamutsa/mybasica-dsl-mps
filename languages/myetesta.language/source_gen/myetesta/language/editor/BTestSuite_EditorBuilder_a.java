...
/*package*/ class BTestSuite_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class testsListHandler_t5rxwk_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.tests$y$54;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BTestSuiteParent$fm;
    }
    ...
    public SNode nodeFactory(SNode prevNode, SNode nextNode, int index) {
      return SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xe19d8a3c67da4363L, 0x8f44c6c0cab85e88L, 0x679b735ccd32951eL, "myetesta.language.structure.BEmpytySuite"));
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(testsListHandler_t5rxwk_c0.this.getNode(), LINKS.tests$y$54));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept BTestSuiteParent$fm = MetaAdapterFactory.getConcept(0xe19d8a3c67da4363L, 0x8f44c6c0cab85e88L, 0x679b735ccd430dfcL, "myetesta.language.structure.BTestSuiteParent");
  }
