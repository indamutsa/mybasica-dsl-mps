...
public class GrammarCellsSubstituteMenu_BNotEqualsExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BNotEqualsExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_xz65fm_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BNotEqualsExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_xz65fm_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.BNotEqualsExpression$sa;
    }
  }
