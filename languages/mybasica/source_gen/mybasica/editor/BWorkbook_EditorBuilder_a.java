...
/*package*/ class BWorkbook_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BWorkbook_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_s5u6y0_a");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contentListHandler_s5u6y0_b0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_content");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class contentListHandler_s5u6y0_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contentListHandler_s5u6y0_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentListHandler_s5u6y0_b0.this.getNode(), LINKS.content$j5u6));
      try {
