...
public class GrammarCellsSubstituteMenu_BIntegerType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BIntegerType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_b7ebnd_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BIntegerType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_b7ebnd_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.BIntegerType$dw;
    }
  }
