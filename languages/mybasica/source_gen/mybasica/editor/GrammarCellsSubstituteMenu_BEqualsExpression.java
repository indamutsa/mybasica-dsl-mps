...
public class GrammarCellsSubstituteMenu_BEqualsExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BEqualsExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_xlefke_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BEqualsExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_xlefke_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.BEqualsExpression$rF;
    }
  }
