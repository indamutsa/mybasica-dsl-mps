...
import mybasica.behavior.BBinaryExpression__BehaviorDescriptor;
...
public class GrammarActionsDescriptor extends AbstractGrammarActionDescriptor implements IGrammarActionsDescriptor {
  ...
  public List<SubstituteMenuItem> getActions(final SubstituteMenuContext _context, final SAbstractConcept expectedOutputConceptExactly) {
    ...
    _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("mybasica.editor.GrammarActionsDescriptor.getActions", null));
    try {
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          ...
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "BBinaryExpression", new SNodePointer("r:23c43e70-7682-4d76-b5ea-74442686e20f(mybasica.editor)", "8045280948040659469")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.BBinaryExpression$TR)) {
              final SAbstractConcept wrappedConcept = CONCEPTS.BExpression$kP;
              for (SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.BBinaryExpression$TR, _context.getModel(), BBinaryExpression_Editor.class, _context.getEditorContext()))) {
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept)) && wrapRequired) {
                  ...
                  if (isApplicable) {
                    List<SubstituteMenuItem> actions = _context.withLink(LINKS.left$Sg7x).createItems(new DefaultSubstituteMenuLookup(LanguageRegistry.getInstance(_context.getEditorContext().getRepository()), wrappedConcept));
                      ...
                      public SubstituteMenuItem select(SubstituteMenuItem it) {
                        ...
                        SubstituteMenuItem wrapper = new SubstituteMenuItemWrapper(it) {
                          ...
                          public SNode createNode(@NotNull String pattern) {
                            ...
                            SLinkOperations.setTarget(wrapper, LINKS.left$Sg7x, SNodeOperations.cast(nodeToWrap, CONCEPTS.BExpression$kP));
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "BBinaryExpression", new SNodePointer("r:23c43e70-7682-4d76-b5ea-74442686e20f(mybasica.editor)", "8045280948040659922")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.BBinaryExpression$TR)) {
              final SAbstractConcept wrappedConcept = CONCEPTS.BExpression$kP;
              for (SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.BBinaryExpression$TR, _context.getModel(), BBinaryExpression_Editor.class, _context.getEditorContext()))) {
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept)) && wrapRequired) {
                  ...
                  boolean isApplicable = GrammarCellsUtil.canBeChild(subconcept, _context);
                  if (isApplicable) {
                    List<SubstituteMenuItem> actions = _context.withLink(LINKS.right$Sg_z).createItems(new DefaultSubstituteMenuLookup(LanguageRegistry.getInstance(_context.getEditorContext().getRepository()), wrappedConcept));
                    List<SubstituteMenuItem> wrappedActions = ListSequence.fromList(actions).where(new IWhereFilter<SubstituteMenuItem>() {
                      public boolean accept(SubstituteMenuItem it) {
                        boolean isApplicable = true;
                        final SAbstractConcept wrappedConcept = it.getOutputConcept();
                      ...
                      public SubstituteMenuItem select(SubstituteMenuItem it) {
                        ...
                        SubstituteMenuItem wrapper = new SubstituteMenuItemWrapper(it) {
                          ...
                          public SNode createNode(@NotNull String pattern) {
                            ...
                            // use setupNode after setting wrapped element to allow access to the wrapped element in node factories
                            SNode wrapper = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(outputConcept));
                            SLinkOperations.setTarget(wrapper, LINKS.right$Sg_z, SNodeOperations.cast(nodeToWrap, CONCEPTS.BExpression$kP));
                            NodeFactoryManager.setupNode(outputConcept, wrapper, _context.getCurrentTargetNode(), _context.getParentNode(), _context.getModel());
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "BExpressionStatement", new SNodePointer("r:23c43e70-7682-4d76-b5ea-74442686e20f(mybasica.editor)", "5372831481539726473")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.BExpressionStatement$6L)) {
              final SAbstractConcept wrappedConcept = CONCEPTS.BExpression$kP;
              for (SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.BExpressionStatement$6L, _context.getModel(), BExpressionStatement_Editor.class, _context.getEditorContext()))) {
                final SConcept outputConcept = ((SConcept) subconcept);
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept)) && wrapRequired) {
                  ...
                  boolean isApplicable = GrammarCellsUtil.canBeChild(subconcept, _context);
                  if (isApplicable) {
                    List<SubstituteMenuItem> actions = _context.withLink(LINKS.expr$7m$x).createItems(new DefaultSubstituteMenuLookup(LanguageRegistry.getInstance(_context.getEditorContext().getRepository()), wrappedConcept));
                    List<SubstituteMenuItem> wrappedActions = ListSequence.fromList(actions).where(new IWhereFilter<SubstituteMenuItem>() {
                      public boolean accept(SubstituteMenuItem it) {
                        boolean isApplicable = true;
                        final SAbstractConcept wrappedConcept = it.getOutputConcept();
                      ...
                      public SubstituteMenuItem select(SubstituteMenuItem it) {
                        ...
                        SubstituteMenuItem wrapper = new SubstituteMenuItemWrapper(it) {
                          ...
                          public SNode createNode(@NotNull String pattern) {
                            ...
                            // use setupNode after setting wrapped element to allow access to the wrapped element in node factories
                            SNode wrapper = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(outputConcept));
                            SLinkOperations.setTarget(wrapper, LINKS.expr$7m$x, SNodeOperations.cast(nodeToWrap, CONCEPTS.BExpression$kP));
                            NodeFactoryManager.setupNode(outputConcept, wrapper, _context.getCurrentTargetNode(), _context.getParentNode(), _context.getModel());
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "BNumberLiteral", new SNodePointer("r:23c43e70-7682-4d76-b5ea-74442686e20f(mybasica.editor)", "5372831481539777571")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.BNumberLiteral$YN)) {
              final SAbstractConcept expectedOutputConcept = GrammarCellsUtil.getExpectedOutputConcept(_context, expectedOutputConceptExactly);

              for (SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.BNumberLiteral$YN, _context.getModel(), BNumberLiteral_Editor.class, _context.getEditorContext()))) {
                final SConcept outputConcept = ((SConcept) subconcept);
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept))) {
                  ...
                  if (isApplicable) {
                    ListSequence.fromList(result).addElement(new GrammarCellsSubstituteMenuItem(_context) {
                      private SProperty myProperty = PROPS.value$gi_x;
                      ...
                      public SNode createNode(@NotNull String pattern) {
                        ...
                        SPropertyOperations.assign(newNode, PROPS.value$gi_x, GrammarCellsUtil.toInternalPropertyValue(myProperty, pattern));
  ...
  protected List<TransformationMenuItem> doGetSideTransformActions(final TransformationMenuContext _context) {
    ...
    _context.getEditorMenuTrace().pushTraceInfo();
    _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("mybasica.editor.GrammarActionsDescriptor.doGetSideTransformActions", null));
    try {
      {
            ...
            public Iterable<TransformationMenuItem> query(final TransformationMenuContext _context) {
              ...
              try {
                if (_context.getMenuLocation() == MenuLocations.RIGHT_SIDE_TRANSFORM) {
                  final SNode sourceNode = new Parser(_context.getModel()).isEndOf(_context.getNode(), _context.getMenuLocation() == MenuLocations.LEFT_SIDE_TRANSFORM, CONCEPTS.BExpression$kP, null);
                  if (sourceNode != null) {
                    ...
                    for (final SAbstractConcept subconcept : GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.BBinaryExpression$TR, _context.getModel(), BBinaryExpression_Editor.class, _context.getEditorContext())) {
                          ...
                          if (sideTransformationEnabled) {
                            ListSequence.fromList(result).addSequence(Sequence.fromIterable(new MultiTextActionItem(matchingText, _context) {
                              ...
                              protected SNode doSubstitute(@Nullable EditorContext editorContext, String pattern) {
                                ...
                                SNode wrapper = SNodeOperations.cast(SNodeFactoryOperations.createNewNode(subconcept, null), CONCEPTS.BBinaryExpression$TR);
                                SNodeOperations.replaceWithAnother(sourceNode, wrapper);
                                SLinkOperations.setTarget(wrapper, LINKS.left$Sg7x, SNodeOperations.cast(sourceNode, CONCEPTS.BExpression$kP));
                          ...
                          if (sideTransformationEnabled) {
                            ListSequence.fromList(result).addSequence(Sequence.fromIterable(new MultiTextActionItem(matchingText, _context) {
                              ...
                              protected SNode doSubstitute(@Nullable EditorContext editorContext, String pattern) {
                                ...
                                SNode wrapper = SNodeOperations.cast(SNodeFactoryOperations.createNewNode(subconcept, null), CONCEPTS.BBinaryExpression$TR);
                                SNodeOperations.replaceWithAnother(sourceNode, wrapper);
                                SLinkOperations.setTarget(wrapper, LINKS.right$Sg_z, SNodeOperations.cast(sourceNode, CONCEPTS.BExpression$kP));
  ...
  public List<IRule> getRules(final SModel contextModel) {
    ...
    {
      final List<SConcept> subconcepts = GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.BBinaryExpression$TR, visibleLanguages);
      for (final SAbstractConcept subconcept : subconcepts) {
        ListSequence.fromList(rules).addElement(new AbstractRule() {
          ...
          {
            ListSequence.fromList(symbols).addElement(new ChildSymbol(LINKS.left$Sg7x));
            ListSequence.fromList(symbols).addElement(new ConstantSymbol(new Object() {
              public String query(SAbstractConcept subconcept) {
                return SConceptOperations.conceptAlias(subconcept);
              }
            }.query(subconcept)));
            ListSequence.fromList(symbols).addElement(new ChildSymbol(LINKS.right$Sg_z));
          ...
          public boolean isLeftAssociative() {
            return (boolean) BBinaryExpression__BehaviorDescriptor.leftAssociative_id2gymeJUGeK9.invoke(SNodeOperations.asSConcept(subconcept));
          }
          @Override
          public int getPriority() {
            return (int) BBinaryExpression__BehaviorDescriptor.priority_id2gymeJUHdov.invoke(SNodeOperations.asSConcept(subconcept));
          }
        });
      }
    }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept BExpressionStatement$6L = MetaAdapterFactory.getConcept(0x4893d0aba60e42bcL, 0xbfcd58191c291322L, 0x4a9021c4172dfcbaL, "mybasica.structure.BExpressionStatement");
