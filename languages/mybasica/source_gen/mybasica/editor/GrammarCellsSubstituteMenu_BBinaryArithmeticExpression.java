...
public class GrammarCellsSubstituteMenu_BBinaryArithmeticExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BBinaryArithmeticExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_hsm0vo_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BBinaryArithmeticExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_hsm0vo_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.BBinaryArithmeticExpression$Dt;
    }
  }
