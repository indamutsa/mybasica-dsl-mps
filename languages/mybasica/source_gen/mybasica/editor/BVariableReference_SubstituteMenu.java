...
public class BVariableReference_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_xojget_a(), CONCEPTS.BVariableReference$H2));
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for BVariableReference. Generated from implicit smart reference attribute.", new SNodePointer("r:6e326de5-8c63-4e2e-b895-757203818630(mybasica.structure)", "8856941154952288931")));
    try {
  ...
  public class SMP_ReferenceScope_xojget_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_xojget_a() {
      ...
      super((SAbstractConcept) CONCEPTS.BVariableReference$H2, LINKS.variable$QDW2);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_xojget_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.BVariableReference$H2);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
