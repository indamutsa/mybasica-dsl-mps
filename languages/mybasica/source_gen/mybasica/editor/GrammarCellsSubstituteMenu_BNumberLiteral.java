...
public class GrammarCellsSubstituteMenu_BNumberLiteral extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BNumberLiteral() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_jb5g5c_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BNumberLiteral", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_jb5g5c_a extends GrammarCellsSubstituteMenuPart {
    @Override
