...
public class GrammarCellsSubstituteMenu_BBinaryComparisonExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BBinaryComparisonExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_gubiv8_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BBinaryComparisonExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_gubiv8_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.BBinaryComparisonExpression$PZ;
    }
  }
