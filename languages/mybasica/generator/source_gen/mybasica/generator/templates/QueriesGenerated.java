package mybasica.generator.templates;
...
import mybasica.generator.util.NameHelper;
...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_0_0(final PropertyMacroContext _context) {
    return NameHelper.genVarName(_context.getNode());
  }
  public static Object propertyMacro_GetValue_0_1(final PropertyMacroContext _context) {
    return Integer.valueOf(SPropertyOperations.getString(_context.getNode(), PROPS.value$gi_x));
  }
  public static Object propertyMacro_GetValue_0_2(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), PROPS.value$fk51);
  }
  public static Object propertyMacro_GetValue_1_0(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL);
  }
  public static Object referenceMacro_GetReferent_0_0(final ReferenceMacroContext _context) {
    return SLinkOperations.getTarget(_context.getOutputNodeByInputNodeAndMappingLabel(SLinkOperations.getTarget(_context.getNode(), LINKS.variable$QDW2), "var"), LINKS.localVariableDeclaration$RpjM);
  }
  public static SNode sourceNodeQuery_0_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.value$u7jp);
  }
  ...
  public static SNode sourceNodeQuery_2_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.left$Sg7x);
  }
  public static SNode sourceNodeQuery_2_1(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.right$Sg_z);
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_1_0(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.content$j5u6);
  }
  private final Map<String, SourceNodeQuery> snqMethods = new HashMap<String, SourceNodeQuery>();
  {
    int i = 0;
    snqMethods.put("2835046499760404774", new SNQ(i++));
    snqMethods.put("2835046499760405012", new SNQ(i++));
    snqMethods.put("2909200478671864045", new SNQ(i++));
    snqMethods.put("2909200478671864407", new SNQ(i++));
    snqMethods.put("2909200478671866391", new SNQ(i++));
    snqMethods.put("2909200478671866151", new SNQ(i++));
    snqMethods.put("2909200478671867118", new SNQ(i++));
    snqMethods.put("2909200478671867480", new SNQ(i++));
    snqMethods.put("2909200478671868588", new SNQ(i++));
    snqMethods.put("2909200478671868226", new SNQ(i++));
    snqMethods.put("2909200478671868834", new SNQ(i++));
    snqMethods.put("2909200478671869077", new SNQ(i++));
    snqMethods.put("2909200478671870674", new SNQ(i++));
    snqMethods.put("2909200478671871039", new SNQ(i++));
    snqMethods.put("2909200478671871851", new SNQ(i++));
    snqMethods.put("2909200478671872216", new SNQ(i++));
    snqMethods.put("2909200478671872765", new SNQ(i++));
    snqMethods.put("2909200478671872522", new SNQ(i++));
    snqMethods.put("2909200478671875490", new SNQ(i++));
    snqMethods.put("2909200478671875123", new SNQ(i++));
  }
  @NotNull
  @Override
  ...
  {
    int i = 0;
    snsqMethods.put("2835046499756891378", new SNsQ(i++));
  }
  @NotNull
  @Override
  ...
  {
    int i = 0;
    pvqMethods.put("2835046499758951016", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "a"));
    pvqMethods.put("2835046499760586524", new PVQ(i++, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc59b314L, 0xf8cc59b315L, "value"), "1"));
    pvqMethods.put("2835046499760599198", new PVQ(i++, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d565d10L, 0xf93d565d11L, "value"), null));
    pvqMethods.put("1233878956111678203", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "map_BWorkbook"));
  }
  @NotNull
  @Override
  ...
  {
    rtqMethods.put("2835046499762138670", new RTQ(0, null));
  }
  @NotNull
  @Override
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty value$fk51 = MetaAdapterFactory.getProperty(0x4893d0aba60e42bcL, 0xbfcd58191c291322L, 0x7aeac81c0f68dee2L, 0x7aeac81c0f68dee3L, "value");
